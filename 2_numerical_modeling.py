...
print(f"{'='*60}")
print("  - results/seir_1993_1996_results.csv")
print("  - results/seir_1993_1996_parameters.csv")
print("  - results/seir_1993_1996_results.png")
print(f"\n{'='*60}")
print("To improve fit, manually adjust parameters at the top of the script.")
print("Key parameters to tune: p_h, p_v, m")
print(f"{'='*60}")